...
//		showSec();
	...
	public void makingmenu() {
		...
		int y = 0;
		while (y == 0) {
			startGameList(); // 붕어빵 게임 시작시 목록
			int menuNo = menuselect(); // 목록 선택
			if (menuNo == 1) {
				clearScreen();
	...
	private void checknow() {
		clearScreen();
		System.out.println("\t┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
		System.out.printf(" \t      가진 돈  \t\t:    %5d원\n", bMonuy);
		System.out.printf(" \t      밀가루   \t\t:    %5d개\n", flour);
		System.out.printf(" \t      팥앙금   \t\t:    %5d개\n", redbeenfilling);
		System.out.printf(" \t      슈크림앙금   \t:    %5d개\n", custardfilling);
		System.out.printf(" \t      청결도   \t\t:    %5d점\n", bClean);
		System.out.printf(" \t      만족도   \t\t:    %5d점\n", bLike);
